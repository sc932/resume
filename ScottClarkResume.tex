...
\textbf{\Large Scott Clark (not currently looking for work)} & \textbf{\today} \\

sclark@yelp.com & cam.cornell.edu/$\sim$sc932 \\
...
\item {\bf Development:} Python, C/C++, CUDA, JavaScript, Java, FORTRAN, MATLAB
